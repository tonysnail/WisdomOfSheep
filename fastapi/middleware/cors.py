"""Provide a placeholder CORSMiddleware implementation."""
...
def _load_real():
    ...
    try:
        ...
        spec = importlib.util.find_spec("fastapi.middleware.cors")
...
if _REAL is not None:
    ...
    class CORSMiddleware:  # pragma: no cover - simple data holder
