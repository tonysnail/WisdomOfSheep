"""Subset of FastAPI encoders required for tests."""
...
def _load_real():
    ...
    try:
        ...
        spec = importlib.util.find_spec("fastapi.encoders")
...
if _REAL is not None:
    ...
    def jsonable_encoder(value: Any) -> Any:  # pragma: no cover - simple passthrough
        return value
